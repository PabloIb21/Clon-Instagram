...
<head>
    ...
    <script src="https://kit.fontawesome.com/279ef1e12d.js" crossorigin="anonymous"></script>
                        ...
                        @else
                            ...
                            <li>
                                @if(Auth::user()->image != null)
                                    <img class="avatar rounded-circle" src="{{ route('user.avatar', ['filename'=>Auth::user()->image]) }}" alt="avatar"> 
                                @endif
                            </li>
